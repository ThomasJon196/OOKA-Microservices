...
class LiquidAnalyzer(
    ...
    val logger: Logger = LoggerFactory.getLogger(LiquidAnalyzer::class.java)
    ...
    fun executeAnalysis(configuration: Configuration) = runBlocking {
        ...
        val gearboxAnalyzer = OilAnalyzer("OIL", status_notification_fun, logger)
        val engineAnalyzer = FuelAnalyzer("FUEL", status_notification_fun, logger)
