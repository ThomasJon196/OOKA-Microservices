...
public class RestAPI {
    ...
    public static void sendAnchorStart() {
        final String url = "http://localhost:8080/anchor_start";
    ...
    public static void sendAnchorStart(Map<String, ComboBox> configuration) {
