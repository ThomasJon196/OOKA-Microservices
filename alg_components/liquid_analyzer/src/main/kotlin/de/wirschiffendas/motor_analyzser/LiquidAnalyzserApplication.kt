...
@SpringBootApplication class LiquidAnalyzserApplication

fun main(args: Array<String>) {
    runApplication<LiquidAnalyzserApplication>(*args)
}
...
class MessageController() {
    ...
    fun startConsumingKafka(): ResponseEntity<String> {
        ...
        // Init Analyzer
        val analyser = LiquidAnalyzer(kafkaMessanger::produce_statusmessage)
        kafkaMessanger.consume(topic = "ooka_jonasweber_liquid", analyser::executeAnalysis)
